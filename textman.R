...
# Required by textman_get_doc_chunk_freqs_list()
textman_chunk_text_by_size = function(text.v, chunk_size=300, percentage=TRUE) {
...
textman_get_topic_model = function(corpus.df, stopwords = "stopwords.txt", z = 20, opt_interval = 40, burn_in = 80, iters = 400) {
